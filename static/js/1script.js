...
$(document).ready(function() {
    $(".user-setting a").on("click", function(event) {
        event.stopPropagation(); // Allow clicks inside the dropdown
    });

    $(".user-img").on("click", function(event) {
        $(".user-setting").toggle(); // Open the dropdown
        event.stopPropagation();
    });

    $(document).on("click", function() {
        $(".user-setting").hide(); // Close dropdown when clicking outside
    });
});
...
$("body *").not('.top-area > .setting-area > li').on("click", function() {
 ...
 $(".user-setting a").on("click", function(event) {
    event.stopPropagation(); // Ensure clicks on links are not blocked
});
